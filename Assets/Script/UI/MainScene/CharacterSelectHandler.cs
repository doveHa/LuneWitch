...
namespace Script.UI.MainScene
{
    ...
    {
        [SerializeField] private TextMeshProUGUI characterName, introduction, skillIntroduction;
        [SerializeField] private Image characterIcon;
        [SerializeField] private Transform characterButtonScrollContent;

        void Start()
        {
            SetCharacter(ResourceManager.Load<CharacterData>(Constant.ResourcePath.CHARACTER_DATA_PATH_BY_NAME("Lumina")));
        }
        ...
        public void SetCharacter(CharacterData characterData)
        {
            ...
            characterIcon.sprite = characterData.sprite;
